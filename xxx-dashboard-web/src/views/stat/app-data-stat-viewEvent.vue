        ...
        <el-container style=" background-color: #ffffff; border-radius:6px ;">
            <el-main>
                ...
                <el-table :data="tableData"
                    ...
                    <el-table-column align="left" label="查看事件视频总数" min-width="10%">
                        <template slot-scope="scope">
                            {{ scope.row.totalEvents }}
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column align="left" label="平均每个事件视频的查看时长" min-width="10%">
                        <template slot-scope="scope">
                    ...
                    <el-table-column align="left" label="平均每人查看事件数" min-width="10%">
                        <template slot-scope="scope">
                            {{ scope.row.avgEventsPerUser }}
                        </template>
                    </el-table-column>
                    <el-table-column align="center" label="每日每人查看事件时长的分布">
                    ...
                    <el-table-column align="center" label="每日每个事件被查看的时长分布">
...
import { getViewEventData } from '@/api/api-stat'
...
export default {
    ...
    methods: {
        getData() {
            ...
            getViewEventData(param).then(response => {
